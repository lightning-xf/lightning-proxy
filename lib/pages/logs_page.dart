          ...
          ? AppBar(
              ...
              actions: [
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (context) => [
                    PopupMenuItem(value: 'all', child: Text(s.get('all_logs'))),
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(s.get('logs_copied')),
        ...
        children: [
          ...
          IconButton(
            icon: Icon(
              ...
              size: 22,
              color:
                  uiState.autoScroll ? theme.colorScheme.primary : Colors.grey,
            ),
            onPressed: () {
              ref.read(logsPageUIProvider.notifier).toggleAutoScroll();
            },
