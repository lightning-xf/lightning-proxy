      ...
      child: AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text(
              widget.node == null ? s.get('add_node') : s.get('edit_node'),
        ...
        content: SizedBox(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                _buildSectionTitle(s.get('basic_config')),
                _buildDropdown<String>(
                  label: s.get('protocol'),
                  value: _protocol,
                  items: [
                    'vmess',
                    'vless',
                ...
                _buildTextField(
                  ...
                  label: s.get('node_name'),
                  hint: s.get('node_name'),
                ),
                Row(
                  children: [
                    Expanded(
                ...
                if (_protocol == 'vmess' || _protocol == 'vless')
                  _buildTextField(
                    ...
                    label: s.get('uuid'),
                    hint: s.get('uuid_hint'),
                  ),
                if (_protocol == 'vmess')
                  _buildDropdown<String>(
                    label: s.get('security_type'),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildTextField(
                          ...
                          label: s.get('keep_alive_interval'),
                          hint: '20',
                          keyboardType: TextInputType.number,
                        ),
                      ),
                ...
                _buildSectionTitle(s.get('transport_config')),
                _buildDropdown<String>(
                  label: s.get('transport_type'),
                  value: _network,
                  items: {
                    'tcp',
                    'ws',
                ...
                if (_network == 'grpc') ...[
                  _buildTextField(
                    ...
                    label: s.get('service_name'),
                    hint: 'grpc service name',
                  ),
                  _buildDropdown<String>(
                    label: s.get('grpc_mode'),
                    value: _mode,
                    items: ['gun', 'multi'],
                    onChanged: (v) => setState(() => _mode = v!),
                  ),
                ...
                if (_protocol == 'vmess' ||
                    ...
                    _protocol == 'shadowsocks') ...[
                  const SizedBox(height: 16),
                  _buildSectionTitle(s.get('security_config')),
                  _buildDropdown<String>(
                    label: s.get('stream_security'),
                    value: _security,
                  ...
                  if (_security == 'reality') ...[
                    _buildTextField(
                      ...
                      label: s.get('reality_public_key'),
                      hint: 'Public Key',
                    ),
                    _buildTextField(
                      controller: _shortIdController,
                      label: s.get('reality_short_id'),
                      hint: s.get('optional'),
                    ),
                    _buildTextField(
                      controller: _spiderXController,
                      label: s.get('spider_x'),
                      hint: s.get('optional'),
                    ),
                  ],
                ],
                if (_protocol == 'vmess' ||
                    ...
                    _protocol == 'trojan') ...[
                  const SizedBox(height: 16),
                  _buildSectionTitle(s.get('mux_config')),
                  SwitchListTile(
                    title: Text(
                      s.get('enable_mux'),
