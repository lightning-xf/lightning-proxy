class NodeModel {
  ...
  final String? pinSHA256; // For certificate pinning
  ...
  final Map<String, dynamic>?
      rawData; // Original import metadata for 100% fidelity
  ...
  factory NodeModel.fromJson(Map<String, dynamic> json) => NodeModel(
        ...
        pinSHA256: json['pinSHA256'],
        wgSecretKey: json['wgSecretKey'],
        wgLocalAddress: json['wgLocalAddress'] != null
            ? List<String>.from(json['wgLocalAddress'])
            : null,
